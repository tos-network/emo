...
# end Emo specific end-to-end test
...
# Emo specific end-to-end test
# (independend of gateway-conformance)
# This tests link to parent specific to boxo + relative pathing end-to-end tests specific to Emo.
...
# Emo specific end-to-end test
# (independend of gateway-conformance)
# HTML specific to Boxo/Emo, and relative pathing specific to code in Emo
