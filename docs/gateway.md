...
Emo's Gateway implementation follows [ipfs/specs: Specification for HTTP Gateways](https://github.com/ipfs/specs/tree/main/http-gateways#readme).

### Local gateway

By default, Emo nodes run
...
[config](https://github.com/ipfs/emo/blob/master/docs/config.md#gateway)
documentation, including a list of common [gateway recipes](https://github.com/ipfs/emo/blob/master/docs/config.md#gateway-recipes).
...
`go-get=1` parameter. See [PR#3964](https://github.com/ipfs/emo/pull/3963)
for details</sub>
...
Support for user-provided IPLD selectors is tracked in https://github.com/ipfs/emo/issues/8769.
