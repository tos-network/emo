...
- [Emo changelog v0.15](#emo-changelog-v015)
  - [v0.15.0](#v0150)
    - [Overview](#overview)
...
This means plugins can inject their own implementations of Emo interfaces.
This enables granular customization of Emo behavior by plugins, such as:
...
Extra plugin info [here](https://github.com/ipfs/emo/blob/master/docs/plugins.md#fx-experimental).

#### 📁 `$IPFS_PATH/gateway` file

This adds a new file in the `IPFS_PATH` folder similar to `$IPFS_PATH/api` containing an address based on [`Addresses.Gateway`](https://github.com/ipfs/emo/blob/master/docs/config.md#addressesgateway) configuration.
...
- github.com/ipfs/emo:
  ...
  - feat: make corehttp a reusable component ([ipfs/emo#9070](https://github.com/ipfs/emo/pull/9070))
  - feat: go-libp2p v0.21 (rcmgr auto scaling) ([ipfs/emo#9074](https://github.com/ipfs/emo/pull/9074))
  -  ([ipfs/emo#9024](https://github.com/ipfs/emo/pull/9024))
  -  ([ipfs/emo#9100](https://github.com/ipfs/emo/pull/9100))
  -  ([ipfs/emo#9095](https://github.com/ipfs/emo/pull/9095))
  - chore(cmd): add shutdown to CLI help ([ipfs/emo#9194](https://github.com/ipfs/emo/pull/9194))
  - docs: add fx plugin documentation to plugins.md (#9191) ([ipfs/emo#9191](https://github.com/ipfs/emo/pull/9191))
  - chore: switch to dist.ipfs.tech
  - feat: add fx options plugin
  - feat: add blake3 support
  - Add reference to Experimental config doc (#9181) ([ipfs/emo#9181](https://github.com/ipfs/emo/pull/9181))
  - feat: add $IPFS_PATH/gateway file
  - docs: replace `docs.ipfs.io` with `docs.ipfs.tech` (#9158) ([ipfs/emo#9158](https://github.com/ipfs/emo/pull/9158))
  ...
  - chore: update emo-as-a-library example
  - docs(readme): add maintainer info (#9141) ([ipfs/emo#9141](https://github.com/ipfs/emo/pull/9141))
  - fix(gw): 404 when a valid DAG is missing link
  - fix(gw): directory URL normalization ([ipfs/emo#9123](https://github.com/ipfs/emo/pull/9123))
  ...
  - docs(readme): move content to docs website (#9102) ([ipfs/emo#9102](https://github.com/ipfs/emo/pull/9102))
