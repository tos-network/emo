...
We have consolidated many IPFS repos into [Boxo](https://github.com/ipfs/boxo), and this release switches Emo over to use Boxo instead of those repos, resulting in the removal of 27 dependencies from Emo:
...
You can learn more about the [Boxo 0.8 release](https://github.com/ipfs/boxo/releases/tag/v0.8.0) that Emo now depends and the general effort to get Boxo to be a stable foundation [here](https://github.com/ipfs/boxo/issues/196).
...
enabled us to clean up some legacy code and remove dependency on Emo
internals.
...
gateway functionality without the rest of Emo.
...
Emo sharness tests, and are working on
...
- Some Emo-specific prometheus metrics are no longer available.
...
- The legacy opt-in `Gateway.Writable` is no longer available as of Emo 0.20.
...
You can read more about the rationale behind this decision on the [tracking issue](https://github.com/ipfs/emo/issues/9757).

#### Reminder: `ipfs pubsub` commands and matching HTTP endpoints are deprecated and will be removed

`ipfs pubsub` commands and all `/api/v0/pubsub/` RPC endpoints and will be removed in the next release. For more information and rational see [#9717](https://github.com/ipfs/emo/issues/9717).
...
- github.com/ipfs/emo:
  - fix: deadlock on retrieving WebTransport addresses (#9857) ([ipfs/emo#9857](https://github.com/ipfs/emo/pull/9857))
  - docs(config): remove mentions of relay v1 (#9860) ([ipfs/emo#9860](https://github.com/ipfs/emo/pull/9860))
  - Merge branch 'master' into merge-release-v0.19.2
  - docs: add changelog for v0.19.2
  - feat: webui@3.0.0 (#9835) ([ipfs/emo#9835](https://github.com/ipfs/emo/pull/9835))
  - fix: use default HTTP routers when FullRT DHT client is used (#9841) ([ipfs/emo#9841](https://github.com/ipfs/emo/pull/9841))
  - chore: update version
  - docs: add `ipfs pubsub` deprecation reminder to changelog (#9827) ([ipfs/emo#9827](https://github.com/ipfs/emo/pull/9827))
  - docs: preparing 0.20 changelog for release (#9799) ([ipfs/emo#9799](https://github.com/ipfs/emo/pull/9799))
  - feat: boxo tracing and traceparent support (#9811) ([ipfs/emo#9811](https://github.com/ipfs/emo/pull/9811))
  - chore: update version
  - chore: update version
  - update go-libp2p to v0.27.0
  - docs: add optimistic provide feature description
  - feat: add experimental optimistic provide
  - fix(ci): speed up docker build (#9800) ([ipfs/emo#9800](https://github.com/ipfs/emo/pull/9800))
  - feat(tracing): use OTEL_PROPAGATORS as per OTel spec (#9801) ([ipfs/emo#9801](https://github.com/ipfs/emo/pull/9801))
  - docs: fix jaeger command (#9797) ([ipfs/emo#9797](https://github.com/ipfs/emo/pull/9797))
  - Merge Release: v0.19.1 (#9794) ([ipfs/emo#9794](https://github.com/ipfs/emo/pull/9794))
  - chore: upgrade OpenTelemetry dependencies (#9736) ([ipfs/emo#9736](https://github.com/ipfs/emo/pull/9736))
  - test: fix flaky content routing over HTTP test (#9772) ([ipfs/emo#9772](https://github.com/ipfs/emo/pull/9772))
  - feat: allow injecting custom path resolvers (#9750) ([ipfs/emo#9750](https://github.com/ipfs/emo/pull/9750))
  - feat: add changelog entry for router timeouts for v0.19.1 (#9784) ([ipfs/emo#9784](https://github.com/ipfs/emo/pull/9784))
  - feat(gw): new metrics and HTTP range support (#9786) ([ipfs/emo#9786](https://github.com/ipfs/emo/pull/9786))
  - feat!: make --empty-repo default (#9758) ([ipfs/emo#9758](https://github.com/ipfs/emo/pull/9758))
  - fix: remove timeout on default DHT operations (#9783) ([ipfs/emo#9783](https://github.com/ipfs/emo/pull/9783))
  - refactor: switch gateway code to new API from go-libipfs (#9681) ([ipfs/emo#9681](https://github.com/ipfs/emo/pull/9681))
  - test: port remote pinning tests to Go (#9720) ([ipfs/emo#9720](https://github.com/ipfs/emo/pull/9720))
  - feat: add identify option to swarm peers command
  - test: port routing DHT tests to Go (#9709) ([ipfs/emo#9709](https://github.com/ipfs/emo/pull/9709))
  - test: fix autoclient flakiness (#9769) ([ipfs/emo#9769](https://github.com/ipfs/emo/pull/9769))
  - test: skip flaky pubsub test (#9770) ([ipfs/emo#9770](https://github.com/ipfs/emo/pull/9770))
  ...
  - feat: remove writable gateway (#9743) ([ipfs/emo#9743](https://github.com/ipfs/emo/pull/9743))
  - Process Improvement: v0.18.0 ([ipfs/emo#9484](https://github.com/ipfs/emo/pull/9484))
  - fix: deadlock while racing `ipfs dag import` and `ipfs repo gc`
  - feat: improve dag/import (#9721) ([ipfs/emo#9721](https://github.com/ipfs/emo/pull/9721))
  - ci: remove circleci config ([ipfs/emo#9687](https://github.com/ipfs/emo/pull/9687))
  - docs: use fx.Decorate instead of fx.Replace in examples (#9725) ([ipfs/emo#9725](https://github.com/ipfs/emo/pull/9725))
  - Create Changelog: v0.20 ([ipfs/emo#9742](https://github.com/ipfs/emo/pull/9742))
  - Merge Release: v0.19.0 ([ipfs/emo#9741](https://github.com/ipfs/emo/pull/9741))
  - feat(gateway): invalid CID returns 400 Bad Request (#9726) ([ipfs/emo#9726](https://github.com/ipfs/emo/pull/9726))
  - fix: remove outdated changelog part ([ipfs/emo#9739](https://github.com/ipfs/emo/pull/9739))
  ...
  - docs: fix typos
  - Update Version: v0.19 ([ipfs/emo#9698](https://github.com/ipfs/emo/pull/9698))
