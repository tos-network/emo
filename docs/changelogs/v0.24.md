...
This Emo release ships with built-in content-blocking subsystem [announced earlier this year](https://blog.ipfs.tech/2023-content-blocking-for-the-ipfs-stack/).
...
Learn more at [`/docs/content-blocking.md`](https://github.com/ipfs/emo/blob/master/docs/content-blocking.md)
...
This Emo release includes the initial work towards WebRTC Direct
...
The `/webrtc-direct` transport is disabled by default in Emo 0.24,
and not ready for production use yet, but we plan to enable it in a future release.

See [`Swarm.Transports.Network.WebRTCDirect`](https://github.com/ipfs/emo/blob/master/docs/config.md#swarmtransportsnetworkwebrtcdirect)
...
- github.com/ipfs/emo:
  ...
  - Release: v0.24.0-1 ([ipfs/emo#10190](https://github.com/ipfs/emo/pull/10190))
