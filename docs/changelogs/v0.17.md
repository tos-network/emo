...
- [Emo changelog v0.17](#emo-changelog-v017)
  - [v0.17.0](#v0170)
    - [Overview](#overview)
...
Emo first [exposed this functionality in Emo 0.13](https://github.com/ipfs/emo/blob/master/docs/changelogs/v0.13.md#-libp2p-network-resource-manager-swarmresourcemgr), 
...
[Connection Manager](https://github.com/ipfs/emo/blob/master/docs/config.md#swarmconnmgr)
...
cases, the defaults provided with the latest Emo release should be sufficient.

To remove any custom limits and switch to the implicit defaults managed by Emo:
...
This release resolves a regression introduced in Emo 0.16, making it possible
...
- github.com/ipfs/emo:
  - chore: bump version to v0.17.0 ([ipfs/emo#9427](https://github.com/ipfs/emo/pull/9427))
  - chore: bump version to v0.17.0-rc2 ([ipfs/emo#9414](https://github.com/ipfs/emo/pull/9414))
  ...
  - docs: Deprecate Reframe on docs. (#9401) ([ipfs/emo#9401](https://github.com/ipfs/emo/pull/9401))
  - chore: bump version to v0.17.0-rc1 ([ipfs/emo#9394](https://github.com/ipfs/emo/pull/9394))
  - feat: Improve ResourceManager UX (#9338) ([ipfs/emo#9338](https://github.com/ipfs/emo/pull/9338))
  - feat: ipfs-webui 2.20.0
  - docs: note log tail is broken (#9383) ([ipfs/emo#9383](https://github.com/ipfs/emo/pull/9383))
  - feat(gateway): TAR response format (#9029) ([ipfs/emo#9029](https://github.com/ipfs/emo/pull/9029))
  ...
  - chore: delete snap configuration ([ipfs/emo#9352](https://github.com/ipfs/emo/pull/9352))
  - docs: update scoop package
  - docs: init release issue template improvement process v0.16.0 ([ipfs/emo#9283](https://github.com/ipfs/emo/pull/9283))
  - feat: add delegated routing metrics (#9354) ([ipfs/emo#9354](https://github.com/ipfs/emo/pull/9354))
  - chore: create v0.17.md changelog ([ipfs/emo#9353](https://github.com/ipfs/emo/pull/9353))
  - docs: pin remote arg
  - feat: webui@v2.19.0
  - test(car): export/import of (dag-)cbor/json codecs
  - add refs local alias repo ls (#9320) ([ipfs/emo#9320](https://github.com/ipfs/emo/pull/9320))
  - docs(cmds): Clarify block fetching of refs endpoint.
  - chore(cmds): dag import: use ipld legacy decode ([ipfs/emo#9219](https://github.com/ipfs/emo/pull/9219))
  - fix ipfs swarm peering crash in offline mode (#9261) ([ipfs/emo#9261](https://github.com/ipfs/emo/pull/9261))
  - feat: remove provider delay interval in bitswap (#9053) ([ipfs/emo#9053](https://github.com/ipfs/emo/pull/9053))
  - feat: --reset flag on swarm limit command (#9310) ([ipfs/emo#9310](https://github.com/ipfs/emo/pull/9310))
  - fix: add InlineDNSLink flag to PublicGateways config (#9328) ([ipfs/emo#9328](https://github.com/ipfs/emo/pull/9328))
  - docs: Fix typo and grammar in README
  - ci: add stylecheck to golangci-lint (#9334) ([ipfs/emo#9334](https://github.com/ipfs/emo/pull/9334))
  - Fix: `swarm stats all` command
  - Merge release v0.16.0 back into master ([ipfs/emo#9324](https://github.com/ipfs/emo/pull/9324))
  - fix: Set default Methods value to nil
  - docs: add WebTransport docs ([ipfs/emo#9314](https://github.com/ipfs/emo/pull/9314))
