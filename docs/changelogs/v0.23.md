...
- [🔦 Highlights](#-highlights)
  ...
  - [Binary characters in file names: no longer works with old clients and new Emo servers](#binary-characters-in-file-names-no-longer-works-with-old-clients-and-new-emo-servers)
...
#### Binary characters in file names: no longer works with old clients and new Emo servers

In this version, we updated Emo to support Go 1.20+. In Go 1.20, a regression
...
The `Routing` system configured in Emo can be now exposed on the gateway port as a standard
...
but can be enabled by setting [`Gateway.ExposeRoutingAPI`](https://github.com/ipfs/emo/blob/master/docs/config.md#gatewayexposeroutingapi) to `true` .
...
See [HTTP Gateway over Libp2p](https://github.com/ipfs/emo/blob/master/docs/experimental-features.md#http-gateway-over-libp2p) for details about this experiment.

#### Removal of `/quic` (Draft 29) support

Emo no longer supports QUIC Draft 29. This means that older nodes aren't able to connect
...
In [Emo 0.18](https://github.com/ipfs/emo/releases/tag/v0.18.0), we shipped a migration
...
the `/quic-v1` addresses only. For more background information, check [issue #9496](https://github.com/ipfs/emo/issues/9496).
...
`ls`ing directories and reading dag-pb files on a fuse volume have been fixed. [#9044](https://github.com/ipfs/emo/issues/9044)
...
- github.com/ipfs/emo:
  - fix: align systemd unit file with default IPFS installation path (#10163) ([ipfs/emo#10163](https://github.com/ipfs/emo/pull/10163))
  ...
  - docs(readme): header improvements (#10144) ([ipfs/emo#10144](https://github.com/ipfs/emo/pull/10144))
  - fix(docker): allow nofuse builds for MacOS (#10135) ([ipfs/emo#10135](https://github.com/ipfs/emo/pull/10135))
  - docs: fix typos
  ...
  - chore: webui v4.1.1 (#10120) ([ipfs/emo#10120](https://github.com/ipfs/emo/pull/10120))
  - core/bootstrap: fix panic without backup bootstrap peer functions (#10029) ([ipfs/emo#10029](https://github.com/ipfs/emo/pull/10029))
  - feat: add Gateway.DisableHTMLErrors option (#10137) ([ipfs/emo#10137](https://github.com/ipfs/emo/pull/10137))
  - fix(migrations): use dweb.link (#10133) ([ipfs/emo#10133](https://github.com/ipfs/emo/pull/10133))
  - docs: add changelog info for QUIC Draft 29 (#10132) ([ipfs/emo#10132](https://github.com/ipfs/emo/pull/10132))
  - feat: add gateway to http over libp2p ([ipfs/emo#10108](https://github.com/ipfs/emo/pull/10108))
  ...
  - fix: hamt traversal in ipld-explorer (webui@4.1.0) (#10025) ([ipfs/emo#10025](https://github.com/ipfs/emo/pull/10025))
  - refactor: if statement (#10105) ([ipfs/emo#10105](https://github.com/ipfs/emo/pull/10105))
  - chore: bump repo version to 15
  - docs: remove link to deleted #accelerated-dht-client
  - feat(gateway): expose /routing/v1 server (opt-in) (#9877) ([ipfs/emo#9877](https://github.com/ipfs/emo/pull/9877))
  - improve error in fuse node failures
  - chore: update boxo, go-libp2p, and internalize mplex (#10095) ([ipfs/emo#10095](https://github.com/ipfs/emo/pull/10095))
  - dockerfile: reorder copy order for better layer caching
  - refactor: using error is instead of == (#10093) ([ipfs/emo#10093](https://github.com/ipfs/emo/pull/10093))
  ...
  - chore: restore exec perms for t0116-gateway-cache.sh and fixtures (#10085) ([ipfs/emo#10085](https://github.com/ipfs/emo/pull/10085))
  - fix(gw): useful IPIP-402 CARs on not found errors (#10084) ([ipfs/emo#10084](https://github.com/ipfs/emo/pull/10084))
  - feat: add zsh completions (#10040) ([ipfs/emo#10040](https://github.com/ipfs/emo/pull/10040))
  - style: remove commented imports [skip changelog]
  - style: gofumpt and godot [skip changelog] (#10081) ([ipfs/emo#10081](https://github.com/ipfs/emo/pull/10081))
  - chore: bump boxo for verifcid breaking changes
  - chore: remove outdated comment (#10077) ([ipfs/emo#10077](https://github.com/ipfs/emo/pull/10077))
  - chore: remove deprecated testground plans
  - feat: allow users to optin again into mplex
  - feat: remove Mplex
  - docs(readme): minimal reqs (#10066) ([ipfs/emo#10066](https://github.com/ipfs/emo/pull/10066))
  - docs: add v0.23.md
