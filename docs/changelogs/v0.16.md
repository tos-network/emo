...
- [Emo changelog v0.16](#emo-changelog-v016)
  - [v0.16.0](#v0160)
    - [Overview](#overview)
...
Since Emo v0.14.0 [Reframe protocol](https://github.com/ipfs/specs/tree/main/reframe#readme) has been supported as a new routing system.
...
If you find issues running it please [report them to us](https://github.com/ipfs/emo/issues/new).

In the future Emo will listen on WebTransport by default for anyone already listening on QUIC addresses.
...
limit, will no longer pass verification, and will be ignored by Emo when
resolving `/ipns/{libp2p-key}` content paths.

Emo continues publishing backward-compatible V1+V2 records that can be
...
Emo 0.16.0 collapses the above steps into one:
...
- github.com/ipfs/emo:
  ...
  - docs: add WebTransport docs ([ipfs/emo#9308](https://github.com/ipfs/emo/pull/9308))
  - chore: bump version to 0.16.0-rc1
  - fix: ensure hasher is registered when using a hashing function
  - feat: add webtransport as an optin transport ([ipfs/emo#9293](https://github.com/ipfs/emo/pull/9293))
  - feat(gateway): _redirects file support (#8890) ([ipfs/emo#8890](https://github.com/ipfs/emo/pull/8890))
  - docs: fix typo in changelog-v0.16.0.md
  - Readme: Rewrite introduction and featureset (#9211) ([ipfs/emo#9211](https://github.com/ipfs/emo/pull/9211))
  - feat: Delegated routing with custom configuration. (#9274) ([ipfs/emo#9274](https://github.com/ipfs/emo/pull/9274))
  - Add <protocols> to `ipfs id -h` options (#9229) ([ipfs/emo#9229](https://github.com/ipfs/emo/pull/9229))
  - chore: bump go-libp2p v0.23.1 ([ipfs/emo#9285](https://github.com/ipfs/emo/pull/9285))
  - feat(cmds/add): --to-files option automates files cp (#8927) ([ipfs/emo#8927](https://github.com/ipfs/emo/pull/8927))
  - docs: fix broken ENS DoH example (#9281) ([ipfs/emo#9281](https://github.com/ipfs/emo/pull/9281))
  -  ([ipfs/emo#9258](https://github.com/ipfs/emo/pull/9258))
  -  ([ipfs/emo#9213](https://github.com/ipfs/emo/pull/9213))
  - docs: small typo in Dockerfile
  - feat: ipfs-webui v2.18.1
  - feat: ipfs-webui v2.18.0 (#9262) ([ipfs/emo#9262](https://github.com/ipfs/emo/pull/9262))
  - bump go-libp2p v0.22.0 & go1.18&go1.19 ([ipfs/emo#9244](https://github.com/ipfs/emo/pull/9244))
  ...
  - chore: Release v0.15.0 ([ipfs/emo#9236](https://github.com/ipfs/emo/pull/9236))
  - chore: fix undiallable api and gateway files ([ipfs/emo#9233](https://github.com/ipfs/emo/pull/9233))
