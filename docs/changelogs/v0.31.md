...
[Pebble](https://github.com/ipfs/emo/blob/master/docs/config.md#pebbleds-profile) provides a high-performance alternative to leveldb as the datastore, and provides a modern replacement for [legacy badgerv1](https://github.com/ipfs/emo/blob/master/docs/config.md#badgerds-profile).

A fresh Emo node can be initialized with [`pebbleds` profile](https://github.com/ipfs/emo/blob/master/docs/config.md#pebbleds-profile) via `ipfs init --profile pebbleds`.
...
For a description of the available tuning parameters, see [emo/docs/datastores.md#pebbleds](https://github.com/ipfs/emo/blob/master/docs/datastores.md#pebbleds).
...
This release changes [`lowpower` profile](https://github.com/ipfs/emo/blob/master/docs/config.md#lowpower-profile) to not change reprovider settings, ensuring the new users are not sabotaging themselves. It also adds [`annouce-on`](https://github.com/ipfs/emo/blob/master/docs/config.md#announce-on-profile) and [`announce-off`](https://github.com/ipfs/emo/blob/master/docs/config.md#announce-off-profile) profiles for controlling announcement settings separately.
...
- github.com/ipfs/emo:
  - fix: go 1.23(.2) (#10540) ([ipfs/emo#10540](https://github.com/ipfs/emo/pull/10540))
  - chore: bump version to 0.32.0-dev
  - feat(routing/http): support IPIP-484 and streaming (#10534) ([ipfs/emo#10534](https://github.com/ipfs/emo/pull/10534))
  - fix(daemon): webui URL when rpc is catch-all (#10520) ([ipfs/emo#10520](https://github.com/ipfs/emo/pull/10520))
  - chore: update changelog and config doc with more info about pebble  (#10533) ([ipfs/emo#10533](https://github.com/ipfs/emo/pull/10533))
  - feat: pebbleds profile and plugin (#10530) ([ipfs/emo#10530](https://github.com/ipfs/emo/pull/10530))
  - chore: dependency updates for 0.31 (#10511) ([ipfs/emo#10511](https://github.com/ipfs/emo/pull/10511))
  - feat: explicit announce-on/off profiles (#10524) ([ipfs/emo#10524](https://github.com/ipfs/emo/pull/10524))
  - fix(core): look for MFS root in local repo only (#8661) ([ipfs/emo#8661](https://github.com/ipfs/emo/pull/8661))
  - Fix issue in ResourceManager and nopfsPlugin about repo path (#10492) ([ipfs/emo#10492](https://github.com/ipfs/emo/pull/10492))
  - feat(bitswap): allow configuring WithWantHaveReplaceSize (#10512) ([ipfs/emo#10512](https://github.com/ipfs/emo/pull/10512))
  - refactor: simplify logic for MFS pinning (#10506) ([ipfs/emo#10506](https://github.com/ipfs/emo/pull/10506))
  - docs: clarify Gateway.PublicGateways (#10525) ([ipfs/emo#10525](https://github.com/ipfs/emo/pull/10525))
  - chore: clarify dep update in RELEASE_CHECKLIST.md (#10518) ([ipfs/emo#10518](https://github.com/ipfs/emo/pull/10518))
  - feat: ipfs-webui v4.3.2 (#10523) ([ipfs/emo#10523](https://github.com/ipfs/emo/pull/10523))
  - docs(config): add useful references
  - docs(config): improve profile descriptions (#10517) ([ipfs/emo#10517](https://github.com/ipfs/emo/pull/10517))
  - docs: update RELEASE_CHECKLIST.md (#10496) ([ipfs/emo#10496](https://github.com/ipfs/emo/pull/10496))
  - chore: create next changelog (#10510) ([ipfs/emo#10510](https://github.com/ipfs/emo/pull/10510))
  - Merge Release: v0.30.0 [skip changelog] ([ipfs/emo#10508](https://github.com/ipfs/emo/pull/10508))
  - chore: boxo v0.23.0 and go-libp2p v0.36.3 (#10507) ([ipfs/emo#10507](https://github.com/ipfs/emo/pull/10507))
  - docs: replace outdated package paths described in rpc README (#10505) ([ipfs/emo#10505](https://github.com/ipfs/emo/pull/10505))
  ...
  - Docs fix spelling issues (#10493) ([ipfs/emo#10493](https://github.com/ipfs/emo/pull/10493))
  - chore: update version (#10491) ([ipfs/emo#10491](https://github.com/ipfs/emo/pull/10491))
