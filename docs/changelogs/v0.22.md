...
Previously, Emo already provided CARs in DFS order without duplicate blocks.
...
and the same blocks as Emo 0.21.

Emo 0.22 still only supports DFS block ordering (`order=dfs`). However, it is
...
- github.com/ipfs/emo:
  ...
  - chore: remove sharness tests ported to conformance testing (#9999) ([ipfs/emo#9999](https://github.com/ipfs/emo/pull/9999))
  - ci: switch from testing against js-ipfs to helia (#10042) ([ipfs/emo#10042](https://github.com/ipfs/emo/pull/10042))
  - chore: merge release back into master
  - chore: change orbitdb to haydenyoung EARLY_TESTERS
  - Fix usage numbers
  - chore: update early testers list (#9218) ([ipfs/emo#9218](https://github.com/ipfs/emo/pull/9218))
  - docs: changelog v0.21 fixes (#10037) ([ipfs/emo#10037](https://github.com/ipfs/emo/pull/10037))
  - refactor(ci): simplify Dockerfile and add docker image testing (#10021) ([ipfs/emo#10021](https://github.com/ipfs/emo/pull/10021))
  ...
  - fix: mark all routers DoNotWaitForSearchValue (#10020) ([ipfs/emo#10020](https://github.com/ipfs/emo/pull/10020))
  - feat(gateway): support for ipip-412 parameters
  - docs(commands): explain that swarm connect can reuse existing connections or known addresses (#10015) ([ipfs/emo#10015](https://github.com/ipfs/emo/pull/10015))
  - docs: add Brave to RELEASE_ISSUE_TEMPLATE.md (#10012) ([ipfs/emo#10012](https://github.com/ipfs/emo/pull/10012))
  - feat: webui@4.0.2
  -  ([ipfs/emo#10008](https://github.com/ipfs/emo/pull/10008))
  ...
  - docs: update refs to emoreleaser in RELEASE_ISSUE_TEMPLATE.md
  ...
  - fix(gateway): include CORS on subdomain redirects (#9994) ([ipfs/emo#9994](https://github.com/ipfs/emo/pull/9994))
  - fix: docker repository initialization race condition
  - feat(ipns): records with V2-only signatures (#9932) ([ipfs/emo#9932](https://github.com/ipfs/emo/pull/9932))
  - cmds/dag/import: pin roots by default (#9966) ([ipfs/emo#9966](https://github.com/ipfs/emo/pull/9966))
  - docs: fix 0.21 changelog
  - feat!: dag import - don't pin roots by default (#9926) ([ipfs/emo#9926](https://github.com/ipfs/emo/pull/9926))
  - fix(cmd): useful errors in dag import (#9945) ([ipfs/emo#9945](https://github.com/ipfs/emo/pull/9945))
  - feat: webui@4.0.1 (#9940) ([ipfs/emo#9940](https://github.com/ipfs/emo/pull/9940))
  - chore(docs): typo http→https
  - fix: more stable prometheus test (#9944) ([ipfs/emo#9944](https://github.com/ipfs/emo/pull/9944))
  -  ([ipfs/emo#9937](https://github.com/ipfs/emo/pull/9937))
