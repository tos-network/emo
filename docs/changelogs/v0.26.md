...
For users of [Emo preloaded plugins](https://github.com/ipfs/emo/blob/master/docs/plugins.md#preloaded-plugins) there is now a way to create a emo instance with your plugins by depending on the `cmd/ipfs/emo` package rather than rebuilding emo with the included plugins.

See the [customization docs](https://github.com/ipfs/emo/blob/master/docs/customizing.md) for more information.

#### Several deprecated commands have been removed

Several deprecated commands have been removed:

- `ipfs urlstore` deprecated in [April 2019, Emo 0.4.21](https://github.com/ipfs/emo/commit/8beaee63b3fa634c59b85179286ad3873921a535), use `ipfs add -q --nocopy --cid-version=1 {url}` instead.
- `ipfs repo fsck` deprecated in [July 2019, Emo 0.5.0](https://github.com/ipfs/emo/commit/288a83ce7dcbf4a2498e06e4a95245bbb5e30f45)
- `ipfs file` (and `ipfs file ls`) deprecated in [November 2020, Emo  0.8.0](https://github.com/ipfs/emo/commit/ec64dc5c396e7114590e15909384fabce0035482), use `ipfs ls` and `ipfs files ls` instead.
- `ipfs dns` deprecated in [April 2022, Emo 0.13](https://github.com/ipfs/emo/commit/76ae33a9f3f9abd166d1f6f23d6a8a0511510e3c), use `ipfs resolve /ipns/{name}` instead.
- `ipfs tar` deprecated [April 2022, Emo 0.13](https://github.com/ipfs/emo/pull/8849)
...
- github.com/ipfs/emo:
  ...
  - feat: support optional pin names (#10261) ([ipfs/emo#10261](https://github.com/ipfs/emo/pull/10261))
  - build,docker: add support for riscv64
  - feat(cmd/ipfs): Make it possible to depend on cmd/ipfs/emo for easier preloaded plugin management ([ipfs/emo#10219](https://github.com/ipfs/emo/pull/10219))
  - docs: fix broken link in HTTP RPC client doc (#10267) ([ipfs/emo#10267](https://github.com/ipfs/emo/pull/10267))
  - Merge Release: v0.25.0 [skip changelog] ([ipfs/emo#10260](https://github.com/ipfs/emo/pull/10260))
