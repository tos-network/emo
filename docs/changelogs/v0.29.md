...
> We encourage users to try it and report any issues in [emo#4143](https://github.com/ipfs/emo/issues/4143).
...
- github.com/ipfs/emo:
  ...
  - chore: libp2p 0.34.1 (#10429) ([ipfs/emo#10429](https://github.com/ipfs/emo/pull/10429))
  - refactor: stop using github.com/pkg/errors (#10431) ([ipfs/emo#10431](https://github.com/ipfs/emo/pull/10431))
  - chore: fix --help text
  - config: introduce Import section (#10421) ([ipfs/emo#10421](https://github.com/ipfs/emo/pull/10421))
  - feat: enables searching pins by name (#10412) ([ipfs/emo#10412](https://github.com/ipfs/emo/pull/10412))
  - fix(fuse): ipfs path parsing (#10243) ([ipfs/emo#10243](https://github.com/ipfs/emo/pull/10243))
  - core/node: fix divide by zero fatal crash for reprovide rate check (#10411) ([ipfs/emo#10411](https://github.com/ipfs/emo/pull/10411))
  - chore: bump to go-ipfs-cmds @ v0.11
  - chore: create next changelog
  - Merge Release: v0.28.0 [skip changelog] ([ipfs/emo#10402](https://github.com/ipfs/emo/pull/10402))
  - docs: update release checklist (#10401) ([ipfs/emo#10401](https://github.com/ipfs/emo/pull/10401))
  - chore: update version
