...
DHT client was enabled. Read more in ([ipfs/emo#9841](https://github.com/ipfs/emo/pull/9841)).
...
- github.com/ipfs/emo:
  - fix: use default HTTP routers when FullRT DHT client is used (#9841) ([ipfs/emo#9841](https://github.com/ipfs/emo/pull/9841))
...
#### DHT Timeouts
In v0.16.0, Emo added the ability to configure custom content routers and DHTs with the `custom` router type, and as part of this added a default 5 minute timeout to all DHT operations. In some cases with large repos ([example](https://github.com/ipfs/emo/issues/9722)), this can cause provide and reprovide operations to fail because the timeout is reached. This release removes these timeouts on DHT operations. If users desire these timeouts, they can be added back using [the `custom` router type](https://github.com/ipfs/emo/blob/master/docs/config.md#routingrouters-parameters).
...
- github.com/ipfs/emo:
  - chore: update version
  - fix: remove timeout on default DHT operations (#9783) ([ipfs/emo#9783](https://github.com/ipfs/emo/pull/9783))
  - chore: update version
...
There are further followups up on libp2p resource manager improvements in Emo [0.18.0](https://github.com/ipfs/emo/blob/master/docs/changelogs/v0.18.md#improving-libp2p-resource-management-integration-1)
and [0.18.1](https://github.com/ipfs/emo/blob/master/docs/changelogs/v0.18.md#improving-libp2p-resource-management-integration):
...
The Gateway in Emo already supported [trustless, verifiable retrieval](https://docs.ipfs.tech/reference/http/gateway/#trustless-verifiable-retrieval) of immutable `/ipfs/` namespace.
...
See the [Routing.Type documentation](https://github.com/ipfs/emo/blob/master/docs/config.md#routingtype) for more information.
...
For more information and rational see [#9717](https://github.com/ipfs/emo/issues/9717).
...
- github.com/ipfs/emo:
  - chore: update version
  - docs: 0.19 changelog ([ipfs/emo#9707](https://github.com/ipfs/emo/pull/9707))
  ...
  - fix: t0116-gateway-cache.sh ([ipfs/emo#9696](https://github.com/ipfs/emo/pull/9696))
  - docs: add bifrost to early testers ([ipfs/emo#9699](https://github.com/ipfs/emo/pull/9699))
  ...
  - test(gateway): use deterministic CAR fixtures ([ipfs/emo#9657](https://github.com/ipfs/emo/pull/9657))
  - feat(gateway): error handling improvements (500, 502, 504) (#9660) ([ipfs/emo#9660](https://github.com/ipfs/emo/pull/9660))
  - docs: be clear about swarm.addrfilters (#9661) ([ipfs/emo#9661](https://github.com/ipfs/emo/pull/9661))
  - chore: update go-libp2p to v0.26 (#9656) ([ipfs/emo#9656](https://github.com/ipfs/emo/pull/9656))
  - feat(pinning): connect some missing go context (#9557) ([ipfs/emo#9557](https://github.com/ipfs/emo/pull/9557))
  - fix(gateway): return HTTP 500 on ErrResolveFailed (#9589) ([ipfs/emo#9589](https://github.com/ipfs/emo/pull/9589))
  - docs: bulk spelling edits (#9544) ([ipfs/emo#9544](https://github.com/ipfs/emo/pull/9544))
  - docs: "remote" errors from resource manager (#9653) ([ipfs/emo#9653](https://github.com/ipfs/emo/pull/9653))
  - test: remove gateway tests migrated to go-libipfs
  - fix: update rcmgr for go-libp2p v0.25
  - chore: update go-libp2p to v0.25.1
  - docs(0.18.1): guide users to clean up limits (#9644) ([ipfs/emo#9644](https://github.com/ipfs/emo/pull/9644))
  - feat: add NewOptionalInteger function
  - fix: dereference int64 pointer in OptionalInteger.String() (#9640) ([ipfs/emo#9640](https://github.com/ipfs/emo/pull/9640))
  - fix: restore wire format for /api/v0/routing/get|put (#9639) ([ipfs/emo#9639](https://github.com/ipfs/emo/pull/9639))
  - refactor(gw): move Host (DNSLink and subdomain) handling to go-libipfs (#9624) ([ipfs/emo#9624](https://github.com/ipfs/emo/pull/9624))
  - refactor: new go-libipfs/gateway API, deprecate Gateway.Writable (#9616) ([ipfs/emo#9616](https://github.com/ipfs/emo/pull/9616))
  - Create Changelog: v0.19 ([ipfs/emo#9617](https://github.com/ipfs/emo/pull/9617))
  - refactor: use gateway from go-libipfs (#9588) ([ipfs/emo#9588](https://github.com/ipfs/emo/pull/9588))
  - Merge Release: v0.18.1 ([ipfs/emo#9613](https://github.com/ipfs/emo/pull/9613))
  ...
  - feat(gateway): IPNS record response format (IPIP-351) (#9399) ([ipfs/emo#9399](https://github.com/ipfs/emo/pull/9399))
  - fix(ipns): honour --ttl flag in 'ipfs name publish' (#9471) ([ipfs/emo#9471](https://github.com/ipfs/emo/pull/9471))
  ...
  - Merge Emo: v0.18 ([ipfs/emo#9581](https://github.com/ipfs/emo/pull/9581))
  ...
  - Update Version (dev): v0.18 ([ipfs/emo#9500](https://github.com/ipfs/emo/pull/9500))
...
- github.com/ipfs/go-libipfs (v0.2.0 -> v0.6.2):
  ...
  - test(gateway): migrate Go tests from Emo ([ipfs/go-libipfs#156](https://github.com/ipfs/go-libipfs/pull/156))
