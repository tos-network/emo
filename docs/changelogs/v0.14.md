...
this transitional period Emo nodes were sending twice as many LAN packets,
which ends with this release: we've [removed](https://github.com/ipfs/emo/pull/9048) the legacy implementation.
...
We've renamed Go-IPFS to Emo ([details](https://github.com/ipfs/go-ipfs/issues/8959)).

Published artifacts use `emo` now, and are available at:

- https://dist.ipfs.tech/emo/
- https://hub.docker.com/r/ipfs/emo/
...
The libp2p identify useragent of Emo has also been changed from `go-ipfs` to `emo`.
...
Emo now supports [`base256emoji`](https://github.com/multiformats/multibase/blob/master/rfcs/Base256Emoji.md) encoding in all [Multibase](https://docs.ipfs.tech/concepts/glossary/#multibase) contexts. Use it for testing Unicode support, as visual aid while explaining Multiformats, or just for fun:
...
- github.com/ipfs/emo:
  ...
  - fix: emo in daemon and cli stdout
  ...
  - feat(routing): Delegated Routing (#8997) ([ipfs/emo#8997](https://github.com/ipfs/emo/pull/8997))
  - chore: changelogs split
  - feat(gw): Cache-Control: only-if-cached
  - chore(deps): webui v2.15.1
  - Follow-ups after repository rename
 ([ipfs/emo#9098](https://github.com/ipfs/emo/pull/9098))
  - docs: refine wording
  - docs: refine the wording of provider strategies
  - refactor: rename to emo
 ([ipfs/emo#8958](https://github.com/ipfs/emo/pull/8958))
  - fix: correct cache-control in car responses
  - docs: v0.13.1 (#9093) ([ipfs/emo#9093](https://github.com/ipfs/emo/pull/9093))
  - chore: update go-car ([ipfs/emo#9089](https://github.com/ipfs/emo/pull/9089))
  - update go-libp2p to v0.20.3 ([ipfs/emo#9038](https://github.com/ipfs/emo/pull/9038))
  - docs: add SECURITY.md (#9062) ([ipfs/emo#9062](https://github.com/ipfs/emo/pull/9062))
  - fix: remove mdns_legacy & Discovery.MDNS.Interval
  - refactor: prealloc slices with known sizes (#8892) ([ipfs/emo#8892](https://github.com/ipfs/emo/pull/8892))
  - docs: fix typo in `cid/base32`
  - docs: mark Swarm.ResourceMgr as experimental
  - chore: replace ioutil with io and os (#8969) ([ipfs/emo#8969](https://github.com/ipfs/emo/pull/8969))
  ...
  - chore: bump Go to 1.18.3 (#9021) ([ipfs/emo#9021](https://github.com/ipfs/emo/pull/9021))
  - feat: upgrade to go-libp2p-kad-dht@v0.16.0 (#9005) ([ipfs/emo#9005](https://github.com/ipfs/emo/pull/9005))
  - docs: fix typo in the `swarm/peering` help text
  - feat: disable resource manager by default (#9003) ([ipfs/emo#9003](https://github.com/ipfs/emo/pull/9003))
  - fix: adjust rcmgr limits for accelerated DHT client rt refresh (#8982) ([ipfs/emo#8982](https://github.com/ipfs/emo/pull/8982))
  - fix(ci): make go-ipfs-as-a-library work without external peers (#8978) ([ipfs/emo#8978](https://github.com/ipfs/emo/pull/8978))
  - feat: log when resource manager limits are exceeded (#8980) ([ipfs/emo#8980](https://github.com/ipfs/emo/pull/8980))
  - fix: JS caching via Access-Control-Expose-Headers (#8984) ([ipfs/emo#8984](https://github.com/ipfs/emo/pull/8984))
  - docs: fix abstractions typo
  - fix: hanging goroutine in get fileArchive handler
  - chore: mark fuse experimental (#8962) ([ipfs/emo#8962](https://github.com/ipfs/emo/pull/8962))
  - fix(node/libp2p): disable rcmgr checkImplicitDefaults ([ipfs/emo#8965](https://github.com/ipfs/emo/pull/8965))
  - Add 'ipfs repo migrate' command (#8428) ([ipfs/emo#8428](https://github.com/ipfs/emo/pull/8428))
  - pubsub multibase encoding (#8933) ([ipfs/emo#8933](https://github.com/ipfs/emo/pull/8933))
  - 'pin rm' helptext: rewrite description as object is not removed from local storage (immediately) ([ipfs/emo#8947](https://github.com/ipfs/emo/pull/8947))
  -  ([ipfs/emo#8934](https://github.com/ipfs/emo/pull/8934))
  - Add instructions to resolve repo migration error (#8946) ([ipfs/emo#8946](https://github.com/ipfs/emo/pull/8946))
