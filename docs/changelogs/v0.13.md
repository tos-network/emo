...
and the [`v0/dag/import`](https://docs.ipfs.tech/reference/emo/rpc/#api-v0-dag-import) endpoint.
...
https://docs.ipfs.tech/reference/emo/rpc/ now includes separate sections for _experimental_ and _deprecated_ commands.
