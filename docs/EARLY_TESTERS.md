...
* When Emo enters the second release stage (public beta), early testers will be asked to test Emo on non-production infrastructure. This may involve things like:
...
* When Emo enters the third release stage (soft release), early testers will be asked to partially deploy the release candidate to production infrastructure. Release candidates at this stage are expected to be identical to the final release. However, this stage allows the Emo team to fix any last-minute regressions without cutting an entirely new release.
